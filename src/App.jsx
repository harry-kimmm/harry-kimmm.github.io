    ...
    <>
      <ScrollAnimation animateIn="fadeInDown" animateOnce="true" duration="1">
        ...
        <ButtonGroup size="large" aria-label="large button group">
          ...
          <IconButton href="src\assets\Harry_Kim.pdf" target="_blank"><FeedIcon style={{ color: 'white' }} /></IconButton>
        </ButtonGroup >
      </ScrollAnimation>
            ...
            <Grid item xs="auto">
              <ScrollAnimation animateIn="fadeInRight" animateOnce="true" duration="0.5">
                <Card sx={{ maxWidth: 600 }}>
                  <CardMedia
                    sx={{ height: 250 }}
                    image="src/assets/a-plus-i-img.png"
                    title="A+I"
                  />
                  <CardContent>
            ...
            <Grid item xs="auto">
              <ScrollAnimation animateIn="fadeInRight" animateOnce="true" duration="0.5">
                <Card sx={{ maxWidth: 600 }}>
                  <CardMedia
                    sx={{ height: 250 }}
                    image="src/assets/vendingmachine-img.png"
            ...
            <Grid item xs="auto">
              <ScrollAnimation animateIn="fadeInRight" animateOnce="true" duration="0.5">
                <Card sx={{ maxWidth: 600 }}>
                  <CardMedia
                    sx={{ height: 250 }}
                    image="src/assets/eunited-img.png"
            ...
            <Grid item xs="auto">
              <ScrollAnimation animateIn="fadeInRight" animateOnce="true" duration="0.5">
                <Card sx={{ maxWidth: 600 }}>
                  <CardMedia
                    sx={{ height: 250 }}
                    image="src/assets/personal-portfolio-img.png"
